...
encoder:encoder.o qscale.o slice_size.o code_size.o dct.o main.o bitstream.o slice.o
	gcc -o encoder ${CFLAGS} encoder.o qscale.o slice_size.o code_size.o dct.o main.o  bitstream.o  slice.o -lm
